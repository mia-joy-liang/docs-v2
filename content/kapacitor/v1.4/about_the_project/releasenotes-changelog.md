...
For more details on the scraping and discovery systems, see the full documentation [here](https://github.com/influxdata/docs-v2/blob/master/content/kapacitor/v1.4/working/alerts.md/).
